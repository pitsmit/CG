! function(t, e) {
    ...
    class a {
        ...
        decompose() {
            ...
            if (0 != t || 0 != e) {
                ...
                n.rotation = e > 0 ? Math.acos(t / s) : -Math.acos(t / s), n.scaleX = s, n.scaleY = a / s, n.skewX = (t * i + e * r) / a, n.skewY = 0
            } else if (0 != i || 0 != r) {
                var o = Math.sqrt(i * i + r * r);
                n.rotation = Math.PI / 2 - (r > 0 ? Math.acos(-i / o) : -Math.acos(i / o)), n.scaleX = a / o, n.scaleY = o, n.skewX = 0, n.skewY = (t * i + e * r) / a
            }
    ...
    const c = "undefined" != typeof requestAnimationFrame && requestAnimationFrame || function(t) {
        ...
        g = {
            ...
            colorToRGBA: t => (t = t || "black", g._namedColorToRBA(t) || g._hex3ColorToRGBA(t) || g._hex4ColorToRGBA(t) || g._hex6ColorToRGBA(t) || g._hex8ColorToRGBA(t) || g._rgbColorToRGBA(t) || g._rgbaColorToRGBA(t) || g._hslColorToRGBA(t)),
            _namedColorToRBA(t) {
            ...
            _hslColorToRGBA(t) {
                if (/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.test(t)) {
                    const [e, ...i] = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(t), r = Number(i[0]) / 360, a = Number(i[1]) / 100, n = Number(i[2]) / 100;
                    let s, o, h;
            ...
            releaseCanvas(...t) {
                i.releaseCanvasOnDestroy && t.forEach((t => {
    ...
    function u(t) {
        return g._isString(t) ? '"' + t + '"' : "[object Number]" === Object.prototype.toString.call(t) || g._isBoolean(t) ? t : Object.prototype.toString.call(t)
    }
    ...
    function v(t) {
        if (i.isUnminified) return function(e, i) {
            ...
            return r || a || g.warn(u(e) + ' is a not valid value for "' + i + '" attribute. The value should be a number or Array<number>(' + t + ")"), e
        }
    }

    function m() {
        if (i.isUnminified) return function(t, e) {
            return g._isNumber(t) || "auto" === t || g.warn(u(t) + ' is a not valid value for "' + e + '" attribute. The value should be a number or "auto".'), t
        }
    }
    ...
    const w = {
        ...
        addComponentsGetterSetter(t, e, r, a, n) {
            ...
            var f = function(t) {
                if (i.isUnminified) return function(e, i) {
                    return null == e || g.isObject(e) || g.warn(u(e) + ' is a not valid value for "' + i + '" attribute. The value should be an object with properties ' + t), e
                }
            }(r);
            t.prototype[c] = function(t) {
                var i, s = this.attrs[e];
                for (i in a && (t = a.call(this, t)), f && f.call(this, t, e), t) t.hasOwnProperty(i) && this._setAttr(e + l(i), t[i]);
                return t || r.forEach((t => {
                    this._setAttr(e + l(t), void 0)
                })), this._fireChangeEvent(e, s, t), n && n.call(this), this
    ...
    class P {
        ...
        getTrace(t, e) {
            var i, r, a, n, s = this.traceArr,
                o = s.length,
                h = "";
            for (i = 0; i < o; i++)(a = (r = s[i]).method) ? (n = r.args, h += a, t ? h += "()" : g._isArray(n[0]) ? h += "([" + n.join(",") + "])" : (e && (n = n.map((t => "number" == typeof t ? Math.floor(t) : t))), h += "(" + n.join(",") + ")")) : (h += r.property, t || (h += "=" + r.val)), h += ";";
            return h
        }
        clearTrace() {
            this.traceArr = []
                ...
                n = function(t) {
                    ...
                    i[t] = function() {
                        return e = function(t) {
                            ...
                            return r
                        }(Array.prototype.slice.call(arguments, 0)), r = a.apply(i, arguments), i._trace({
                            method: t,
                            args: e
                        }), r
                    }
    ...
    } ["fillStyle", "strokeStyle", "shadowColor", "shadowBlur", "shadowOffsetX", "shadowOffsetY", "letterSpacing", "lineCap", "lineDashOffset", "lineJoin", "lineWidth", "miterLimit", "direction", "font", "textAlign", "textBaseline", "globalAlpha", "globalCompositeOperation", "imageSmoothingEnabled"].forEach((function(t) {
    ...
    class k extends P {
        ...
        _applyShadow(t) {
            var e, i, r, a = null !== (e = t.getShadowRGBA()) && void 0 !== e ? e : "black",
                ...
                s = null !== (r = t.getShadowOffset()) && void 0 !== r ? r : {
                    x: 0,
                    y: 0
                },
        ...
        constructor(t) {
            ...
            var e = (t || {}).pixelRatio || i.pixelRatio || function() {
                ...
                var t = g.createCanvasElement(),
                    e = t.getContext("2d");
                return T = (i._global.devicePixelRatio || 1) / (e.webkitBackingStorePixelRatio || e.mozBackingStorePixelRatio || e.msBackingStorePixelRatio || e.oBackingStorePixelRatio || e.backingStorePixelRatio || 1), g.releaseCanvas(t), T
            }();
            this.pixelRatio = e, this._canvas = g.createCanvasElement(), this._canvas.style.padding = "0", this._canvas.style.margin = "0", this._canvas.style.border = "0", this._canvas.style.background = "transparent", this._canvas.style.position = "absolute", this._canvas.style.top = "0", this._canvas.style.left = "0"
        }
        getContext() {
            return this.context
        }
    ...
    class G extends M {
        constructor(t = {
            ...
            super(t), this.context = new k(this, {
    ...
    const E = {
        get isDragging() {
            var t = !1;
            return E._dragElements.forEach((e => {
        ...
        _endDragBefore(t) {
            ...
            E._dragElements.forEach((r => {
                ...
                if (!n._changedPointerPositions.find((t => t.id === r.pointerId))) return;
                "dragging" !== r.dragStatus && "stopped" !== r.dragStatus || (E.justDragged = !0, i._mouseListenClick = !1, i._touchListenClick = !1, i._pointerListenClick = !1, r.dragStatus = "stopped");
        ...
        _endDragAfter(t) {
            E._dragElements.forEach(((e, i) => {
                "stopped" === e.dragStatus && e.node.fire("dragend", {
                    ...
                    target: e.node,
                    evt: t
                }, !0), "dragging" !== e.dragStatus && E._dragElements.delete(i)
            }))
        }
    };
    i.isBrowser && (window.addEventListener("mouseup", E._endDragBefore, !0), window.addEventListener("touchend", E._endDragBefore, !0), window.addEventListener("mousemove", E._drag), window.addEventListener("touchmove", E._drag), window.addEventListener("mouseup", E._endDragAfter, !1), window.addEventListener("touchend", E._endDragAfter, !1));
    var D = "absoluteOpacity",
        ...
        X = "transform",
        q = "visible",
        j = ["xChange.konva", "yChange.konva", "scaleXChange.konva", "scaleYChange.konva", "skewXChange.konva", "skewYChange.konva", "rotationChange.konva", "offsetXChange.konva", "offsetYChange.konva", "transformsEnabledChange.konva"].join(z);
    let U = 1;
    class V {
        constructor(t) {
        ...
        _clearCache(t) {
            t !== X && t !== O || !this._cache.get(t) ? t ? this._cache.delete(t) : this._cache.clear() : this._cache.get(t).dirty = !0
        }
        _getCache(t, e) {
            var i = this._cache.get(t);
            return (void 0 === i || (t === X || t === O) && !0 === i.dirty) && (i = e.call(this), this._cache.set(t, i)), i
        }
        _calculate(t, e, i) {
        ...
        cache(t) {
            ...
            if (!r || !a) return void g.error("Can not cache the node. Width or height of the node equals 0. Caching is skipped.");
            const c = Math.abs(Math.round(i.x) - s) > .5 ? 1 : 0,
                u = Math.abs(Math.round(i.y) - o) > .5 ? 1 : 0;
            s -= h, o -= h;
            var f = new G({
                    pixelRatio: n,
                    width: r += 2 * h + c,
                ...
                m = f.getContext(),
                _ = v.getContext();
            return v.isCache = !0, f.isCache = !0, this._cache.delete(F), this._filterUpToDate = !1, !1 === e.imageSmoothingEnabled && (f.getContext()._context.imageSmoothingEnabled = !1, p.getContext()._context.imageSmoothingEnabled = !1), m.save(), _.save(), m.translate(-s, -o), _.translate(-s, -o), this._isUnderCache = !0, this._clearSelfAndDescendantCache(D), this._clearSelfAndDescendantCache(I), this.drawScene(f, this), this.drawHit(v, this), this._isUnderCache = !1, m.restore(), _.restore(), l && (m.save(), m.beginPath(), m.rect(0, 0, r, a), m.closePath(), m.setAttr("strokeStyle", "red"), m.setAttr("lineWidth", 5), m.stroke(), m.restore()), this._cache.set(F, {
                scene: f,
                filter: p,
                hit: v,
                x: s,
        ...
        _getCachedSceneCanvas() {
            ...
            if (a) {
                if (!this._filterUpToDate) {
                    ...
                    try {
                        for (t = a.length, h.clear(), h.drawImage(s._canvas, 0, 0, s.getWidth() / l, s.getHeight() / l), e = h.getImageData(0, 0, o.getWidth(), o.getHeight()), i = 0; i < t; i++) "function" == typeof(r = a[i]) ? (r.call(this, e), h.putImageData(e, 0, 0)) : g.error("Filter should be type of function, but got " + typeof r + " instead. Please check correct filters")
                    } catch (t) {
        ...
        _clearCaches() {
            this._clearSelfAndDescendantCache(O), this._clearSelfAndDescendantCache(D), this._clearSelfAndDescendantCache(I), this._clearSelfAndDescendantCache(Y), this._clearSelfAndDescendantCache(q), this._clearSelfAndDescendantCache(N)
        }
        _remove() {
            this._clearCaches();
        ...
        getAbsoluteZIndex() {
            var t, e, i, r, a = this.getDepth(),
                n = this,
                s = 0;
            const o = this.getStage();
            return "Stage" !== n.nodeType && o && function o(h) {
                for (t = [], e = h.length, i = 0; i < e; i++) r = h[i], s++, r.nodeType !== W && (t = t.concat(r.getChildren().slice())), r._id === n._id && (i = e);
        ...
        _batchTransformChanges(t) {
            this._batchingTransformChange = !0, t(), this._batchingTransformChange = !1, this._needClearTransformCache && (this._clearCache(X), this._clearSelfAndDescendantCache(O)), this._needClearTransformCache = !1
        }
        setPosition(t) {
            return this._batchTransformChanges((() => {
        ...
        setAbsolutePosition(t) {
            ...
            return a.invert(), a.translate(t.x, t.y), t = {
                ...
                x: t.x,
                y: t.y
            }), this._clearCache(X), this._clearSelfAndDescendantCache(O), this
        }
        _setTransform(t) {
            var e;
        ...
        toObject() {
            var t, e, i, r, a = this.getAttrs();
            const n = {
                attrs: {},
                className: this.getClassName()
            };
            for (t in a) e = a[t], g.isObject(e) && !g._isPlainObject(e) && !g._isArray(e) || (i = "function" == typeof this[t] && this[t], delete a[t], r = i ? i.call(this) : null, a[t] = e, r !== e && (n.attrs[t] = e));
            return g._prepareToStringify(n)
        }
        toJSON() {
        ...
        _isMatch(t) {
            ...
            var e, i, r = t.replace(/ /g, "").split(","),
                a = r.length;
            for (e = 0; e < a; e++)
                if (i = r[e], g.isValidSelector(i) || (g.warn('Selector "' + i + '" is invalid. Allowed selectors examples are "#foo", ".bar" or "Group".'), g.warn('If you have a custom shape with such className, please change it to start with upper letter like "Triangle".'), g.warn("Konva is awesome, right?")), "#" === i.charAt(0)) {
        ...
        getAbsoluteTransform(t) {
            return t ? this._getAbsoluteTransform(t) : this._getCache(O, this._getAbsoluteTransform)
        }
        _getAbsoluteTransform(t) {
            ...
            e = this._cache.get(O) || new a, this.parent ? this.parent.getAbsoluteTransform().copyInto(e) : e.reset();
        ...
        _getTransform() {
            var t, e, r = this._cache.get(X) || new a;
            r.reset();
            var n = this.x(),
                s = this.y(),
            ...
            return 0 === n && 0 === s || r.translate(n, s), 0 !== o && r.rotate(o), 0 === d && 0 === c || r.skew(d, c), 1 === h && 1 === l || r.scale(h, l), 0 === g && 0 === u || r.translate(-1 * g, -1 * u), r.dirty = !1, r
        }
        clone(t) {
            var e, i, r, a, n, s = g.cloneObject(this.attrs);
            for (e in t) s[e] = t[e];
            var o = new this.constructor(s);
            for (e in this.eventListeners)
                for (r = (i = this.eventListeners[e]).length, a = 0; a < r; a++)(n = i[a]).name.indexOf("konva") < 0 && (o.eventListeners[e] || (o.eventListeners[e] = []), o.eventListeners[e].push(n));
            return o
        }
        _toKonvaCanvas(t) {
            t = t || {};
            var e = this.getClientRect(),
                ...
                o = s.getContext();
            const h = new G({
                width: s.width / s.pixelRatio + Math.abs(r),
                height: s.height / s.pixelRatio + Math.abs(a),
                pixelRatio: s.pixelRatio
            });
            return !1 === t.imageSmoothingEnabled && (o._context.imageSmoothingEnabled = !1), o.save(), (r || a) && o.translate(-1 * r, -1 * a), this.drawScene(s, void 0, h), o.restore(), s
        }
        toCanvas(t) {
        ...
        toImage(t) {
            return new Promise(((e, i) => {
                try {
                    ...
                    i && delete t.callback, g._urlToImage(this.toDataURL(t), (function(t) {
                        e(t), null == i || i(t)
                    }))
                } catch (t) {
                    i(t)
        ...
        _setAttr(t, e) {
            var i = this.attrs[t];
            (i !== e || g.isObject(e)) && (null == e ? delete this.attrs[t] : this.attrs[t] = e, this._shouldFireChangeEvents && this._fireChangeEvent(t, i, e), this._requestDraw())
        }
        ...
        _fireAndBubble(t, e, i) {
            if (e && this.nodeType === W && (e.target = this), !((t === B || t === H) && (i && (this === i || this.isAncestorOf && this.isAncestorOf(i)) || "Stage" === this.nodeType && !i))) {
                this._fire(t, e);
                var r = (t === B || t === H) && i && i.isAncestorOf && i.isAncestorOf(this) && !i.isAncestorOf(this.parent);
        ...
        startDrag(t, e = !0) {
            ...
            E._dragElements.get(this._id).dragStatus = "dragging", this.fire("dragstart", {
                type: "dragstart",
                target: this,
                evt: t && t.evt
            }, e)
        ...
        _setDragPosition(t, e) {
            ...
            if (i) {
                ...
                if (void 0 !== a) {
                    ...
                    e ? r = e : g.warn("dragBoundFunc did not return any value. That is unexpected behavior. You must return new absolute position from dragBoundFunc.")
                }
        ...
        static _createNode(t, e) {
            var r, a, n, s = V.prototype.getClassName.call(t),
                o = t.children;
            e && (t.attrs.container = e), i[s] || (g.warn('Can not find a node with class name "' + s + '". Fallback to "Shape".'), s = "Shape");
            if (r = new(0, i[s])(t.attrs), o)
                for (a = o.length, n = 0; n < a; n++) r.add(V._createNode(o[n]));
            return r
        }
    }
    V.prototype.nodeType = "Node", V.prototype._attrsAffectingSize = [], V.prototype.eventListeners = {}, V.prototype.on.call(V.prototype, j, (function() {
        this._batchingTransformChange ? this._needClearTransformCache = !0 : (this._clearCache(X), this._clearSelfAndDescendantCache(O))
    ...
    class Q extends V {
        ...
        _drawChildren(t, e, i, r) {
            ...
            if (l) {
                ...
                var c = this.getAbsoluteTransform(i),
                    g = c.getMatrix();
                let t;
                if (n.transform(g[0], g[1], g[2], g[3], g[4], g[5]), n.beginPath(), h) t = h.call(this, n, this);
                else {
                    var u = this.clipX(),
                        f = this.clipY();
                    n.rect(u, f, s, o)
        ...
        getClientRect(t = {}) {
            var e, i, r, a, n, s = t.skipTransform,
                o = t.relativeTo,
                h = {
                    x: 1 / 0,
                    y: 1 / 0,
    ...
    w.addComponentsGetterSetter(Q, "clip", ["x", "y", "width", "height"]), w.addGetterSetter(Q, "clipX", void 0, p()), w.addGetterSetter(Q, "clipY", void 0, p()), w.addGetterSetter(Q, "clipWidth", void 0, p()), w.addGetterSetter(Q, "clipHeight", void 0, p()), w.addGetterSetter(Q, "clipFunc");
    const J = new Map,
    ...
    function rt(t, e) {
        ...
        if (!i) return;
        const r = i.getStage();
        r && r.content, J.delete(t), $ && i._fire("lostpointercapture", tt(new PointerEvent("lostpointercapture")))
    }
    var at = "mouseleave",
        nt = "mouseover",
        st = "mouseenter",
    ...
    class Gt extends Q {
        constructor(t) {
            super(Tt(t)), this._pointerPositions = [], this._changedPointerPositions = [], this._buildDOM(), this._bindContentEvents(), Mt.push(this), this.on("widthChange.konva heightChange.konva", this._resizeDOM), this.on("visibleChange.konva", this._checkVisibility), this.on("clipWidthChange.konva clipHeightChange.konva clipFuncChange.konva", (() => {
                Tt(this.attrs)
        ...
        clone(t) {
            return t || (t = {}), t.container = "undefined" != typeof document && document.createElement("div"), Q.prototype.clone.call(this, t)
        }
        destroy() {
            super.destroy();
            var t = this.content;
            ...
            return e > -1 && Mt.splice(e, 1), g.releaseCanvas(this.bufferCanvas._canvas, this.bufferHitCanvas._canvas), this
        }
        getPointerPosition() {
            ...
            return t ? {
                x: t.x,
                y: t.y
            } : (g.warn("Pointer position is missing and not registered by the stage. Looks like it is outside of the stage container. You can set it manually from event: stage.setPointersPositions(event);"), null)
        }
        _getPointerById(t) {
        ...
        add(t, ...e) {
            ...
            return a > 5 && g.warn("The stage has " + a + " layers. Recommended maximum number of layers is 3-5. Adding more layers into the stage may drop the performance. Rethink your tree structure, you can use Konva.Group."), t.setSize({
                width: this.width(),
                height: this.height()
        ...
        _pointerdown(t) {
            ...
            if (e) {
                ...
                this._changedPointerPositions.forEach((n => {
                    ...
                    if (E.justDragged = !1, i["_" + r + "ListenClick"] = !0, !s || !s.isListening()) return;
                    i.capturePointerEventsEnabled && s.setPointerCapture(n.id), this[r + "ClickStartShape"] = s, s._fireAndBubble(e.pointerdown, {
                        evt: t,
                        pointerId: n.id
                    }), a = !0;
        ...
        _pointermove(t) {
            const e = At(t.type),
                r = kt(t.type);
            if (!e) return;
            if (E.isDragging && E.node.preventDefault() && t.cancelable && t.preventDefault(), this.setPointersPositions(t), !(!E.isDragging || i.hitOnDragEnabled)) return;
            var a = {};
            let n = !1;
            ...
            this._changedPointerPositions.forEach((i => {
                ...
                var d = s !== o;
                if (d && s && (s._fireAndBubble(e.pointerout, {
                        ...l
                    }, o), s._fireAndBubble(e.pointerleave, {
                        ...l
                    }, o)), o) {
                    if (a[o._id]) return;
                    a[o._id] = !0
                }
                o && o.isListening() ? (n = !0, d && (o._fireAndBubble(e.pointerover, {
                    ...l
                }, s), o._fireAndBubble(e.pointerenter, {
                    ...l
                }, s), this[r + "targetShape"] = o), o._fireAndBubble(e.pointermove, {
                    ...l
                })) : s && (this._fire(e.pointerover, {
                    evt: t,
                    target: this,
                    currentTarget: this,
                    pointerId: h
        ...
        _pointerup(t) {
            ...
            this._changedPointerPositions.forEach((h => {
                ...
                let g = !1;
                i["_" + r + "InDblClickWindow"] ? (g = !0, clearTimeout(this[r + "DblTimeout"])) : E.justDragged || (i["_" + r + "InDblClickWindow"] = !0, clearTimeout(this[r + "DblTimeout"])), this[r + "DblTimeout"] = setTimeout((function() {
                    i["_" + r + "InDblClickWindow"] = !1
                }), i.dblClickWindow), l && l.isListening() ? (o = !0, this[r + "ClickEndShape"] = l, l._fireAndBubble(e.pointerup, {
                    ...c
                }), i["_" + r + "ListenClick"] && a && a === l && (l._fireAndBubble(e.pointerclick, {
                    ...c
                }), g && n && n === l && l._fireAndBubble(e.pointerdblclick, {
                    ...c
                }))) : (this[r + "ClickEndShape"] = null, i["_" + r + "ListenClick"] && this._fire(e.pointerclick, {
                    evt: t,
                    target: this,
                    currentTarget: this,
                    pointerId: d
                ...
                currentTarget: this,
                pointerId: this._changedPointerPositions[0].id
            }), i["_" + r + "ListenClick"] = !1, t.cancelable && "touch" !== r && t.preventDefault()
        }
        _contextmenu(t) {
            this.setPointersPositions(t);
            var e = this.getIntersection(this.getPointerPosition());
            e && e.isListening() ? e._fireAndBubble(_t, {
                evt: t
            }) : this._fire(_t, {
                evt: t,
                target: this,
        ...
        _wheel(t) {
            this.setPointersPositions(t);
            var e = this.getIntersection(this.getPointerPosition());
            e && e.isListening() ? e._fireAndBubble(wt, {
                evt: t
            }) : this._fire(wt, {
                evt: t,
                target: this,
    ...
    class Bt extends V {
        ...
        __getLinearGradient() {
            ...
            if (t) {
                for (var e = Ft(), i = this.fillLinearGradientStartPoint(), r = this.fillLinearGradientEndPoint(), a = e.createLinearGradient(i.x, i.y, r.x, r.y), n = 0; n < t.length; n += 2) a.addColorStop(t[n], t[n + 1]);
                return a
            }
        }
        _getRadialGradient() {
        ...
        __getRadialGradient() {
            ...
            if (t) {
                for (var e = Ft(), i = this.fillRadialGradientStartPoint(), r = this.fillRadialGradientEndPoint(), a = e.createRadialGradient(i.x, i.y, this.fillRadialGradientStartRadius(), r.x, r.y, this.fillRadialGradientEndRadius()), n = 0; n < t.length; n += 2) a.addColorStop(t[n], t[n + 1]);
                return a
            }
        }
        getShadowRGBA() {
        ...
        destroy() {
            return V.prototype.destroy.call(this), delete Nt[this.colorKey], delete this.colorKey, this
        }
        _useBufferCanvas(t) {
            var e;
        ...
        drawHit(t, e, i = !1) {
            ...
            var r = this.getLayer(),
                ...
                h = o && o.hit;
            if (this.colorKey || g.warn("Looks like your canvas has a destroyed shape in it. Do not reuse shape after you destroyed it. If you want to reuse shape you should call remove() instead of destroy()"), h) {
                n.save();
                var l = this.getAbsoluteTransform(e).getMatrix();
        ...
        drawHitFromCache(t = 0) {
            var e, i, r, a, n, s = this._getCanvasCache(),
            ...
            try {
                for (r = (i = (e = l.getImageData(0, 0, d, c)).data).length, a = g._hexToRgb(this.colorKey), n = 0; n < r; n += 4) i[n + 3] > t ? (i[n] = a.r, i[n + 1] = a.g, i[n + 2] = a.b, i[n + 3] = 255) : i[n + 3] = 0;
    ...
    class zt extends Q {
        constructor(t) {
            super(t), this.canvas = new G, this.hitCanvas = new R({
                pixelRatio: 1
        ...
        remove() {
            ...
            return V.prototype.remove.call(this), t && t.parentNode && g._isInDocument(t) && t.parentNode.removeChild(t), this
        }
        getStage() {
            return this.parent
        }
        ...
        _toKonvaCanvas(t) {
            return (t = t || {}).width = t.width || this.getWidth(), t.height = t.height || this.getHeight(), t.x = void 0 !== t.x ? t.x : this.x(), t.y = void 0 !== t.y ? t.y : this.y(), V.prototype._toKonvaCanvas.call(this, t)
        }
        _checkVisibility() {
        ...
        drawScene(t, e) {
            ...
            return this._fire("beforeDraw", {
                node: this
            }), this.clearBeforeDraw() && r.getContext().clear(), Q.prototype.drawScene.call(this, r, e), this._fire("draw", {
                node: this
            }), this
        }
        drawHit(t, e) {
            var i = this.getLayer(),
                r = t || i && i.hitCanvas;
            return i && i.clearBeforeDraw() && i.getHitCanvas().getContext().clear(), Q.prototype.drawHit.call(this, r, e), this
        }
        enableHitGraph() {
    ...
    zt.prototype.nodeType = "Layer", r(zt), w.addGetterSetter(zt, "imageSmoothingEnabled", !0), w.addGetterSetter(zt, "clearBeforeDraw", !0), w.addGetterSetter(zt, "hitGraphEnabled", !0, x());
    class Yt extends zt {
        constructor(t) {
    ...
    const qt = e.performance && e.performance.now ? function() {
    ...
    class jt {
        constructor(t, e) {
            this.id = jt.animIdCounter++, this.frame = {
                time: 0,
                timeDiff: 0,
                lastTime: qt(),
                frameRate: 0
        ...
        start() {
            return this.stop(), this.frame.timeDiff = 0, this.frame.lastTime = qt(), jt._addAnimation(this), this
        }
        stop() {
        ...
        static _runFrames() {
            ...
            for (let i = 0; i < e.length; i++) {
                const r = e[i],
                    a = r.layers,
                    n = r.func;
                r._updateFrameObject(qt());
                const s = a.length;
                let o;
                if (o = !n || !1 !== n.call(r, r.frame), o)
                    for (let e = 0; e < s; e++) {
                        const i = a[e];
    ...
    jt.animations = [], jt.animIdCounter = 0, jt.animRunning = !1;
    var Ut = {
            node: 1,
            duration: 1,
            easing: 1,
    ...
    class Jt {
        constructor(t) {
            var e, r, a = this,
                ...
                o = t.easing || $t.Linear,
                h = !!t.yoyo;
            e = void 0 === t.duration ? .3 : 0 === t.duration ? .001 : t.duration, this.node = n, this._id = Vt++;
            var l = n.getLayer() || (n instanceof i.Stage ? n.getLayers() : null);
            for (r in l || g.error("Tween constructor have `node` that is not in a layer. Please add node into layer first."), this.anim = new jt((function() {
                    a.tween.onEnterFrame()
                }), l), this.tween = new Qt(r, (function(t) {
                    a._tweenFunc(t)
                }), o, 0, 1, 1e3 * e, h), this._addListeners(), Jt.attrs[s] || (Jt.attrs[s] = {}), Jt.attrs[s][this._id] || (Jt.attrs[s][this._id] = {}), Jt.tweens[s] || (Jt.tweens[s] = {}), t) void 0 === Ut[r] && this._addAttr(r, t[r]);
            this.reset(), this.onFinish = t.onFinish, this.onReset = t.onReset, this.onUpdate = t.onUpdate
        }
        _addAttr(t, e) {
            var i, r, a, n, s, o, h, l, d = this.node,
                c = d._id;
            if ((a = Jt.tweens[c][t]) && delete Jt.attrs[c][a][t], i = d.getAttr(t), g._isArray(e))
                if (r = [], s = Math.max(e.length, i.length), "points" === t && e.length !== i.length && (e.length > i.length ? (h = i, i = g._prepareArrayForTween(i, e, d.closed())) : (o = e, e = g._prepareArrayForTween(e, i, d.closed()))), 0 === t.indexOf("fill"))
                    for (n = 0; n < s; n++)
                        if (n % 2 == 0) r.push(e[n] - i[n]);
                        else {
                            var u = g.colorToRGBA(i[n]);
                            l = g.colorToRGBA(e[n]), i[n] = u, r.push({
                                r: l.r - u.r,
                                g: l.g - u.g,
                                b: l.b - u.b,
                                a: l.a - u.a
            ...
            else - 1 !== Kt.indexOf(t) ? (i = g.colorToRGBA(i), r = {
        ...
        _tweenFunc(t) {
            var e, i, r, a, n, s, o, h, l = this.node,
            ...
            for (e in d) {
                if (r = (i = d[e]).start, a = i.diff, h = i.end, g._isArray(r))
                    if (n = [], o = Math.max(r.length, h.length), 0 === e.indexOf("fill"))
                        for (s = 0; s < o; s++) s % 2 == 0 ? n.push((r[s] || 0) + a[s] * t) : n.push("rgba(" + Math.round(r[s].r + a[s].r * t) + "," + Math.round(r[s].g + a[s].g * t) + "," + Math.round(r[s].b + a[s].b * t) + "," + (r[s].a + a[s].a * t) + ")");
                    else
                        for (s = 0; s < o; s++) n.push((r[s] || 0) + a[s] * t);
                else n = -1 !== Kt.indexOf(e) ? "rgba(" + Math.round(r.r + a.r * t) + "," + Math.round(r.g + a.g * t) + "," + Math.round(r.b + a.b * t) + "," + (r.a + a.a * t) + ")" : r + a * t;
                l.setAttr(e, n)
            }
        }
        _addListeners() {
    ...
    Jt.attrs = {}, Jt.tweens = {}, V.prototype.to = function(t) {
        var e = t.onFinish;
    ...
    const $t = {
            ...
            BounceEaseInOut: (t, e, i, r) => t < r / 2 ? .5 * $t.BounceEaseIn(2 * t, 0, i, r) + e : .5 * $t.BounceEaseOut(2 * t - r, 0, i, r) + .5 * i + e,
    ...
    function ie(t, e) {
        var i, r, a = t.length,
            n = [];
        for (i = 2; i < a - 2; i += 2) r = ee(t[i - 2], t[i - 1], t[i], t[i + 1], t[i + 2], t[i + 3], e), isNaN(r[0]) || (n.push(r[0]), n.push(r[1]), n.push(t[i]), n.push(t[i + 1]), n.push(r[2]), n.push(r[3]));
        return n
    }
    te.prototype._centroid = !0, te.prototype.className = "Arc", te.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"], r(te), w.addGetterSetter(te, "innerRadius", 0, p()), w.addGetterSetter(te, "outerRadius", 0, p()), w.addGetterSetter(te, "angle", 0, p()), w.addGetterSetter(te, "clockwise", !1, x());
    class re extends Bt {
        constructor(t) {
    ...
    re.prototype.className = "Line", re.prototype._attrsAffectingSize = ["points", "bezier", "tension"], r(re), w.addGetterSetter(re, "closed", !1), w.addGetterSetter(re, "bezier", !1), w.addGetterSetter(re, "tension", 0, p()), w.addGetterSetter(re, "points", [], function() {
        if (i.isUnminified) return function(t, e) {
            const i = Int8Array ? Object.getPrototypeOf(Int8Array) : null;
            return i && t instanceof i || (g._isArray(t) ? t.forEach((function(t) {
                g._isNumber(t) || g.warn('"' + e + '" attribute has non numeric element ' + t + ". Make sure that all elements are numbers.")
            })) : g.warn(u(t) + ' is a not valid value for "' + e + '" attribute. The value should be a array of numbers.')), t
        }
    }());
    const ae = [
            [],
        ...
        oe = (t, e, i) => {
            let r, a, n;
            r = i / 2, a = 0;
            for (let i = 0; i < 20; i++) n = r * ae[20][i] + r, a += ne[20][i] * le(t, e, n);
            return r * a
        },
        he = (t, e, i) => {
            void 0 === i && (i = 1);
    ...
    const de = (t, e, i) => {
            ...
            if (0 === t) {
                n = 0;
                for (let t = 0; t <= r; t++) n += se[r][t] * Math.pow(1 - e, r - t) * Math.pow(e, t) * i[t];
                return n
            }
            a = new Array(r);
    ...
    class ge extends Bt {
                ...
                if ("A" === e.command) {
                    ...
                    if (Math.abs(i - a) < n && (n = Math.abs(i - a)), r < 0)
                        for (let r = i - n; r > a; r -= n) {
                            const i = ge.getPointOnEllipticalArc(e.points[0], e.points[1], e.points[2], e.points[3], r, 0);
                            t.push(i.x, i.y)
                        } else
                            for (let r = i + n; r < a; r += n) {
                                const i = ge.getPointOnEllipticalArc(e.points[0], e.points[1], e.points[2], e.points[3], r, 0);
                    ...
                    for (let i = 0; i <= 1; i += .01) {
                        const r = ge.getPointOnCubicBezier(i, e.start.x, e.start.y, e.points[0], e.points[1], e.points[2], e.points[3], e.points[4], e.points[5]);
                        t.push(r.x, r.y)
        ...
        static getPointAtLengthOfDataArray(t, e) {
            ...
            if (r === a) return {
                x: (i = e[r - 1].points.slice(-2))[0],
                y: i[1]
            };
            if (t < .01) return {
                x: (i = e[r].points.slice(0, 2))[0],
                y: i[1]
            };
            var n = e[r],
                s = n.points;
            switch (n.command) {
                ...
                case "C":
                    return ge.getPointOnCubicBezier(ce(t, ge.getPathLength(e), (t => oe([n.start.x, s[0], s[2], s[4]], [n.start.y, s[1], s[3], s[5]], t))), n.start.x, n.start.y, s[0], s[1], s[2], s[3], s[4], s[5]);
                case "Q":
                    return ge.getPointOnQuadraticBezier(ce(t, ge.getPathLength(e), (t => he([n.start.x, s[0], s[2]], [n.start.y, s[1], s[3]], t))), n.start.x, n.start.y, s[0], s[1], s[2], s[3]);
                case "A":
                    var o = s[0],
                        h = s[1],
                        l = s[2],
                        ...
                        g = s[5],
                        u = s[6];
                    return c += g * t / n.pathLength, ge.getPointOnEllipticalArc(o, h, l, d, c, u)
            }
            return null
        }
        static getPointOnLine(t, e, i, r, a, n, s) {
            ...
            if (r === e) l = {
                ...
                var c, g, u = this.getLineLength(e, i, r, a),
                    f = (n - e) * (r - e) + (s - i) * (a - i);
                c = e + (f /= u * u) * (r - e), g = i + f * (a - i);
                var p = this.getLineLength(n, s, c, g),
                    v = Math.sqrt(t * t - p * p);
                h = Math.sqrt(v * v / (1 + o * o)), r < e && (h *= -1), l = {
                    x: c + h,
                    y: g + (d = o * h)
                }
            }
                ...
                for (; u.length > 0 && !isNaN(u[0]);) {
                    ...
                    switch (g) {
                        ...
                        case "m":
                            var R = u.shift(),
                                E = u.shift();
                            if (h += R, l += E, A = "M", s.length > 2 && "z" === s[s.length - 1].command)
                        ...
                        case "c":
                            ...
                            break;
                        case "S":
                            _ = h, y = l, "C" === (m = s[s.length - 1]).command && (_ = h + (h - m.points[2]), y = l + (l - m.points[3])), T.push(_, y, u.shift(), u.shift()), h = u.shift(), l = u.shift(), A = "C", T.push(h, l);
                            break;
                        case "s":
                            _ = h, y = l, "C" === (m = s[s.length - 1]).command && (_ = h + (h - m.points[2]), y = l + (l - m.points[3])), T.push(_, y, h + u.shift(), l + u.shift()), h += u.shift(), l += u.shift(), A = "C", T.push(h, l);
                            break;
                        case "Q":
                        ...
                        case "q":
                            ...
                            break;
                        case "T":
                            _ = h, y = l, "Q" === (m = s[s.length - 1]).command && (_ = h + (h - m.points[0]), y = l + (l - m.points[1])), h = u.shift(), l = u.shift(), A = "Q", T.push(_, y, h, l);
                            break;
                        case "t":
                            _ = h, y = l, "Q" === (m = s[s.length - 1]).command && (_ = h + (h - m.points[0]), y = l + (l - m.points[1])), h += u.shift(), l += u.shift(), A = "Q", T.push(_, y, h, l);
                            break;
                        case "A":
                            x = u.shift(), b = u.shift(), S = u.shift(), w = u.shift(), C = u.shift(), P = h, k = l, h = u.shift(), l = u.shift(), A = "A", T = this.convertEndpointToCenterParameterization(P, k, h, l, w, C, x, b, S);
                            break;
                        case "a":
                            x = u.shift(), b = u.shift(), S = u.shift(), w = u.shift(), C = u.shift(), P = h, k = l, h += u.shift(), l += u.shift(), A = "A", T = this.convertEndpointToCenterParameterization(P, k, h, l, w, C, x, b, S)
                    }
                    s.push({
                        ...
                        pathLength: this.calcLength(M, G, A || g, T)
                    })
                }
                "z" !== g && "Z" !== g || s.push({
                    command: "z",
            ...
            switch (i) {
                ...
                case "A":
                    ...
                    if (Math.abs(l - c) < g && (g = Math.abs(l - c)), n = h.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], l, 0), d < 0)
                        for (o = l - g; o > c; o -= g) s = h.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], o, 0), a += h.getLineLength(n.x, n.y, s.x, s.y), n = s;
                    else
                        for (o = l + g; o < c; o += g) s = h.getPointOnEllipticalArc(r[0], r[1], r[2], r[3], o, 0), a += h.getLineLength(n.x, n.y, s.x, s.y), n = s;
        ...
        static convertEndpointToCenterParameterization(t, e, i, r, a, n, s, o, h) {
            ...
            var f = u * s * c / o,
                ...
                w = [(-1 * d - f) / s, (-1 * c - p) / o],
                C = x(S, w);
            return y(S, w) <= -1 && (C = Math.PI), y(S, w) >= 1 && (C = 0), 0 === n && C > 0 && (C -= 2 * Math.PI), 1 === n && C < 0 && (C += 2 * Math.PI), [v, m, s, o, b, C, l, n]
        }
    }
    ge.prototype.className = "Path", ge.prototype._attrsAffectingSize = ["data"], r(ge), w.addGetterSetter(ge, "data");
    class ue extends re {
        _sceneFunc(t) {
            super._sceneFunc(t);
            var e = 2 * Math.PI,
    ...
    ue.prototype.className = "Arrow", r(ue), w.addGetterSetter(ue, "pointerLength", 10, p()), w.addGetterSetter(ue, "pointerWidth", 10, p()), w.addGetterSetter(ue, "pointerAtBeginning", !1), w.addGetterSetter(ue, "pointerAtEnding", !0);
    class fe extends Bt {
        _sceneFunc(t) {
    ...
    fe.prototype._centroid = !0, fe.prototype.className = "Circle", fe.prototype._attrsAffectingSize = ["radius"], r(fe), w.addGetterSetter(fe, "radius", 0, p());
    class pe extends Bt {
        _sceneFunc(t) {
            var e = this.radiusX(),
                i = this.radiusY();
    ...
    pe.prototype.className = "Ellipse", pe.prototype._centroid = !0, pe.prototype._attrsAffectingSize = ["radiusX", "radiusY"], r(pe), w.addComponentsGetterSetter(pe, "radius", ["x", "y"]), w.addGetterSetter(pe, "radiusX", 0, p()), w.addGetterSetter(pe, "radiusY", 0, p());
    class ve extends Bt {
        constructor(t) {
        ...
        _sceneFunc(t) {
            ...
            if (a) {
                ...
                n = t && r ? [a, this.cropX(), this.cropY(), t, r, 0, 0, e, i] : [a, 0, 0, e, i]
            }(this.hasFill() || this.hasStroke() || r) && (t.beginPath(), r ? g.drawRoundedRectPath(t, e, i, r) : t.rect(0, 0, e, i), t.closePath(), t.fillStrokeShape(this)), a && (r && t.clip(), t.drawImage.apply(t, n))
        }
        _hitFunc(t) {
            var e = this.width(),
                i = this.height(),
                r = this.cornerRadius();
            t.beginPath(), r ? g.drawRoundedRectPath(t, e, i, r) : t.rect(0, 0, e, i), t.closePath(), t.fillStrokeShape(this)
        }
        getWidth() {
            var t, e;
    ...
    ve.prototype.className = "Image", r(ve), w.addGetterSetter(ve, "cornerRadius", 0, v(4)), w.addGetterSetter(ve, "image"), w.addComponentsGetterSetter(ve, "crop", ["x", "y", "width", "height"]), w.addGetterSetter(ve, "cropX", 0, p()), w.addGetterSetter(ve, "cropY", 0, p()), w.addGetterSetter(ve, "cropWidth", 0, p()), w.addGetterSetter(ve, "cropHeight", 0, p());
    var me = ["fontFamily", "fontSize", "fontStyle", "padding", "lineHeight", "text", "width", "height", "pointerDirection", "pointerWidth", "pointerHeight"],
        _e = "up",
        ye = "right",
        xe = "down",
        be = "left",
    ...
    class we extends Xt {
        ...
        _sync() {
            var t, e, i, r, a, n, s, o = this.getText(),
                h = this.getTag();
            if (o && h) {
    ...
    class Ce extends Bt {
        ...
        getSelfRect() {
            var t = 0,
                ...
                n = this.width(),
                s = this.height();
            return a === _e ? (e -= r, s += r) : a === xe ? s += r : a === be ? (t -= 1.5 * i, n += i) : a === ye && (n += 1.5 * i), {
                x: t,
                y: e,
                width: n,
                height: s
    ...
    Ce.prototype.className = "Tag", r(Ce), w.addGetterSetter(Ce, "pointerDirection", "none"), w.addGetterSetter(Ce, "pointerWidth", 0, p()), w.addGetterSetter(Ce, "pointerHeight", 0, p()), w.addGetterSetter(Ce, "cornerRadius", 0, v(4));
    class Pe extends Bt {
        _sceneFunc(t) {
            var e = this.cornerRadius(),
                i = this.width(),
                r = this.height();
            t.beginPath(), e ? g.drawRoundedRectPath(t, i, r, e) : t.rect(0, 0, i, r), t.closePath(), t.fillStrokeShape(this)
        }
    }
    Pe.prototype.className = "Rect", r(Pe), w.addGetterSetter(Pe, "cornerRadius", 0, v(4));
    class ke extends Bt {
        _sceneFunc(t) {
    ...
    ke.prototype.className = "RegularPolygon", ke.prototype._centroid = !0, ke.prototype._attrsAffectingSize = ["radius"], r(ke), w.addGetterSetter(ke, "radius", 0, p()), w.addGetterSetter(ke, "sides", 0, p());
    var Ae = 2 * Math.PI;
    class Te extends Bt {
        _sceneFunc(t) {
            t.beginPath(), t.arc(0, 0, this.innerRadius(), 0, Ae, !1), t.moveTo(this.outerRadius(), 0), t.arc(0, 0, this.outerRadius(), Ae, 0, !0), t.closePath(), t.fillStrokeShape(this)
        }
        getWidth() {
            return 2 * this.outerRadius()
        }
    ...
    Te.prototype.className = "Ring", Te.prototype._centroid = !0, Te.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"], r(Te), w.addGetterSetter(Te, "innerRadius", 0, p()), w.addGetterSetter(Te, "outerRadius", 0, p());
    class Me extends Bt {
        constructor(t) {
            super(t), this._updated = !0, this.anim = new jt((() => {
                var t = this._updated;
    ...
    Me.prototype.className = "Sprite", r(Me), w.addGetterSetter(Me, "animation"), w.addGetterSetter(Me, "animations"), w.addGetterSetter(Me, "frameOffsets"), w.addGetterSetter(Me, "image"), w.addGetterSetter(Me, "frameIndex", 0, p()), w.addGetterSetter(Me, "frameRate", 17, p()), w.backCompat(Me, {
        index: "frameIndex",
    ...
    Ge.prototype.className = "Star", Ge.prototype._centroid = !0, Ge.prototype._attrsAffectingSize = ["innerRadius", "outerRadius"], r(Ge), w.addGetterSetter(Ge, "numPoints", 5, p()), w.addGetterSetter(Ge, "innerRadius", 0, p()), w.addGetterSetter(Ge, "outerRadius", 0, p());
    var Ee, De = "auto",
        Le = "inherit",
        Oe = "justify",
        Ie = "left",
        ...
        Be = " ",
        He = "none",
        We = ["direction", "fontFamily", "fontSize", "fontStyle", "fontVariant", "padding", "align", "verticalAlign", "lineHeight", "text", "width", "height", "wrap", "ellipsis", "letterSpacing"],
        ze = We.length;
    ...
    class Xe extends Bt {
        constructor(t) {
            ...
            for (var e = 0; e < ze; e++) this.on(We[e] + "Change.konva", this._setTextData);
            this._setTextData()
        }
        _sceneFunc(t) {
            var e = this.textArr,
            ...
            if (this.text()) {
                var r, a = this.padding(),
                    ...
                    _ = (m = s / 2, 0),
                    y = 0;
                for ("rtl" === (h = h === Le ? t.direction : h) && t.setAttr("direction", h), t.setAttr("font", this._getContextFont()), t.setAttr("textBaseline", Fe), t.setAttr("textAlign", Ie), o === Fe ? l = (this.getHeight() - i * s - 2 * a) / 2 : "bottom" === o && (l = this.getHeight() - i * s - 2 * a), t.translate(a, l + a), r = 0; r < i; r++) {
                    _ = 0, y = 0;
                    var x, b, S, w = e[r],
                        C = w.text,
                        P = w.width,
                        k = w.lastInParagraph;
                    if (t.save(), "right" === d ? _ += c - P - 2 * a : "center" === d && (_ += (c - P - 2 * a) / 2), p) {
                        t.save(), t.beginPath(), t.moveTo(_, m + y + Math.round(n / 2)), b = 0 === (x = C.split(" ").length - 1), S = d !== Oe || k ? P : c - 2 * a, t.lineTo(_ + Math.round(S), m + y + Math.round(n / 2)), t.lineWidth = n / 15;
                        const e = this._getLinearGradient();
                        t.strokeStyle = e || u, t.stroke(), t.restore()
                    }
                    if (v) {
                        t.save(), t.beginPath(), t.moveTo(_, m + y), b = 0 === (x = C.split(" ").length - 1), S = d === Oe && k && !b ? c - 2 * a : P, t.lineTo(_ + Math.round(S), m + y), t.lineWidth = n / 15;
                        const e = this._getLinearGradient();
                        t.strokeStyle = e || u, t.stroke(), t.restore()
                    }
                    if ("rtl" === h || 0 === g && d !== Oe) 0 !== g && t.setAttr("letterSpacing", `${g}px`), this._partialTextX = _, this._partialTextY = m + y, this._partialText = C, t.fillStrokeShape(this);
                    else {
                        x = C.split(" ").length - 1;
                        for (var A = Re(C), T = 0; T < A.length; T++) {
                            var M = A[T];
                            " " !== M || k || d !== Oe || (_ += (c - 2 * a - P) / x), this._partialTextX = _, this._partialTextY = m + y, this._partialText = M, t.fillStrokeShape(this), _ += this.measureSize(M).width + g
                        }
                    }
                    t.restore(), i > 1 && (m += s)
                }
        ...
        getWidth() {
            return this.attrs.width === De || void 0 === this.attrs.width ? this.getTextWidth() + 2 * this.padding() : this.attrs.width
        }
        getHeight() {
            return this.attrs.height === De || void 0 === this.attrs.height ? this.fontSize() * this.textArr.length * this.lineHeight() + 2 * this.padding() : this.attrs.height
        }
        getTextWidth() {
        ...
        _getContextFont() {
            return this.fontStyle() + Be + this.fontVariant() + Be + (this.fontSize() + "px ") + this.fontFamily().split(",").map((t => {
        ...
        _getTextWidth(t) {
            var e = this.letterSpacing(),
                i = t.length;
            return Ye().measureText(t).width + (i ? e * (i - 1) : 0)
        }
        _setTextData() {
            ...
            for (var p = f ? this._getTextWidth("…") : 0, v = 0, m = t.length; v < m; ++v) {
                var _ = t[v],
                ...
                if (s && y > l)
                    for (; _.length > 0;) {
                        ...
                        if (u) {
                            var A, T = _[S.length];
                            (A = (T === Be || "-" === T) && w <= l ? S.length : Math.max(S.lastIndexOf(Be), S.lastIndexOf("-")) + 1) > 0 && (x = A, S = S.slice(0, x), w = this._getTextWidth(S))
                        }
                        if (S = S.trimRight(), this._addTextLine(S), i = Math.max(i, w), c += r, this._shouldHandleEllipsis(c)) {
                            this._tryToAddEllipsisToLastLine();
                            break
                        }
                        if ((_ = (_ = _.slice(x)).trimLeft()).length > 0 && (y = this._getTextWidth(_)) <= l) {
                            this._addTextLine(_), c += r, i = Math.max(i, y);
                            break
                        }
                    } else this._addTextLine(_), c += r, i = Math.max(i, y), this._shouldHandleEllipsis(c) && v < m - 1 && this._tryToAddEllipsisToLastLine();
                if (this.textArr[this.textArr.length - 1] && (this.textArr[this.textArr.length - 1].lastInParagraph = !0), o && c + r > d) break
            }
        ...
        _tryToAddEllipsisToLastLine() {
            ...
            if (a && r) {
                if (e) this._getTextWidth(a.text + "…") < i || (a.text = a.text.slice(0, a.text.length - 3));
                this.textArr.splice(this.textArr.length - 1, 1), this._addTextLine(a.text + "…")
            }
        }
    ...
    class Ve extends Bt {
        constructor(t) {
            super(t), this.dummyCanvas = g.createCanvasElement(), this.dataArray = [], this._readDataAttribute(), this.on("dataChange.konva", (function() {
        ...
        _setTextData() {
            ...
            let s = 0;
            "center" === r && (s = Math.max(0, this.pathLength / 2 - n / 2)), "right" === r && (s = Math.max(0, this.pathLength - n));
    ...
    Ve.prototype._fillFunc = je, Ve.prototype._strokeFunc = Ue, Ve.prototype._fillFuncHit = je, Ve.prototype._strokeFuncHit = Ue, Ve.prototype.className = "TextPath", Ve.prototype._attrsAffectingSize = ["text", "fontSize", "data"], r(Ve), w.addGetterSetter(Ve, "data"), w.addGetterSetter(Ve, "fontFamily", "Arial"), w.addGetterSetter(Ve, "fontSize", 12, p()), w.addGetterSetter(Ve, "fontStyle", qe), w.addGetterSetter(Ve, "align", "left"), w.addGetterSetter(Ve, "letterSpacing", 0, p()), w.addGetterSetter(Ve, "textBaseline", "middle"), w.addGetterSetter(Ve, "fontVariant", qe), w.addGetterSetter(Ve, "text", ""), w.addGetterSetter(Ve, "textDecoration", null), w.addGetterSetter(Ve, "kerningFunc", null);
    var Ke = "tr-konva",
        Qe = ["resizeEnabledChange", "rotateAnchorOffsetChange", "rotateEnabledChange", "enabledAnchorsChange", "anchorSizeChange", "borderEnabledChange", "borderStrokeChange", "borderStrokeWidthChange", "borderDashChange", "anchorStrokeChange", "anchorStrokeWidthChange", "anchorFillChange", "anchorCornerRadiusChange", "ignoreStrokeChange", "anchorStyleFuncChange"].map((t => t + `.${Ke}`)).join(" "),
        Je = "nodesRect",
        $e = ["widthChange", "heightChange", "scaleXChange", "scaleYChange", "skewXChange", "skewYChange", "rotationChange", "offsetXChange", "offsetYChange", "transformsEnabledChange", "strokeWidthChange"],
        Ze = {
            "top-left": -45,
            "top-center": 0,
            "top-right": 45,
    ...
    const ti = "ontouchstart" in i._global;
    var ei = ["top-left", "top-center", "top-right", "middle-right", "middle-left", "bottom-left", "bottom-center", "bottom-right"];
    ...
    class ai extends Xt {
        constructor(t) {
            super(t), this._movingAnchorName = null, this._transforming = !1, this._createElements(), this._handleMouseMove = this._handleMouseMove.bind(this), this._handleMouseUp = this._handleMouseUp.bind(this), this.update = this.update.bind(this), this.on(Qe, this.update), this.getNode() && this.update()
        }
        attachTo(t) {
        ...
        setNodes(t = []) {
            ...
            const e = t.filter((t => !t.isAncestorOf(this) || (g.error("Konva.Transformer cannot be an a child of the node you are trying to attach"), !1)));
            return this._nodes = t = e, 1 === t.length && this.useSingleNodeRotation() ? this.rotation(t[0].getAbsoluteRotation()) : this.rotation(0), this._nodes.forEach((t => {
                ...
                t.on(i, e), t.on($e.map((t => t + `.${this._getEventNamespace()}`)).join(" "), e), t.on(`absoluteTransformChange.${this._getEventNamespace()}`, e), this._proxyDrag(t)
        ...
        _createBack() {
            var t = new Bt({
                ...
                sceneFunc(t, e) {
                    var i = e.getParent(),
                        r = i.padding();
                    t.beginPath(), t.rect(-r, -r, e.width() + 2 * r, e.height() + 2 * r), t.moveTo(e.width() / 2, -r), i.rotateEnabled() && i.rotateLineVisible() && t.lineTo(e.width() / 2, -i.rotateAnchorOffset() * g._sign(e.height()) - r), t.fillStrokeShape(e)
                },
                hitFunc: (t, e) => {
        ...
        _handleMouseMove(t) {
            var e, r, a, n = this.findOne("." + this._movingAnchorName),
                s = n.getStage();
                ...
                if ("rotater" !== this._movingAnchorName) {
                    ...
                    if ("top-left" === this._movingAnchorName) {
                        if (c) {
                            ...
                            a = Math.sqrt(Math.pow(f.x - n.x(), 2) + Math.pow(f.y - n.y(), 2));
                            var p = this.findOne(".top-left").x() > f.x ? -1 : 1,
                                v = this.findOne(".top-left").y() > f.y ? -1 : 1;
                            e = a * this.cos * p, r = a * this.sin * v, this.findOne(".top-left").x(f.x - e), this.findOne(".top-left").y(f.y - r)
                        }
                        ...
                        if (c) {
                            ...
                            a = Math.sqrt(Math.pow(n.x() - f.x, 2) + Math.pow(f.y - n.y(), 2));
                            p = this.findOne(".top-right").x() < f.x ? -1 : 1, v = this.findOne(".top-right").y() > f.y ? -1 : 1;
                            e = a * this.cos * p, r = a * this.sin * v, this.findOne(".top-right").x(f.x + e), this.findOne(".top-right").y(f.y - r)
                        }
                        var m = n.position();
                        ...
                        if (c) {
                            ...
                            a = Math.sqrt(Math.pow(f.x - n.x(), 2) + Math.pow(n.y() - f.y, 2));
                            p = f.x < n.x() ? -1 : 1, v = n.y() < f.y ? -1 : 1;
                            e = a * this.cos * p, r = a * this.sin * v, n.x(f.x - e), n.y(f.y + r)
                        }
                        m = n.position(), this.findOne(".top-left").x(m.x), this.findOne(".bottom-right").y(m.y)
                        ...
                        if (c) {
                            ...
                            a = Math.sqrt(Math.pow(n.x() - f.x, 2) + Math.pow(n.y() - f.y, 2));
                            p = this.findOne(".bottom-right").x() < f.x ? -1 : 1, v = this.findOne(".bottom-right").y() < f.y ? -1 : 1;
                            e = a * this.cos * p, r = a * this.sin * v, this.findOne(".bottom-right").x(f.x + e), this.findOne(".bottom-right").y(f.y + r)
                        }
                    ...
                    const s = i.getAngle(this.rotation()) + a,
                        ...
                        h = ri(A, function(t, e, r) {
                            ...
                            return a
                        }(this.rotationSnaps(), s, o) - A.rotation);
        ...
        _fitNodesInto(t, e) {
            ...
            var n = new a;
            if (n.rotate(i.getAngle(this.rotation())), this._movingAnchorName && t.width < 0 && this._movingAnchorName.indexOf("left") >= 0) {
                const e = n.point({
                    x: 2 * -this.padding(),
                    y: 0
                });
            ...
            const s = 1e7,
                o = new a;
            o.translate(r.x, r.y), o.rotate(r.rotation), o.scale(r.width / s, r.height / s);
            const h = new a,
                l = t.width / s,
                d = t.height / s;
            !1 === this.flipEnabled() ? (h.translate(t.x, t.y), h.rotate(t.rotation), h.translate(t.width < 0 ? t.width : 0, t.height < 0 ? t.height : 0), h.scale(Math.abs(l), Math.abs(d))) : (h.translate(t.x, t.y), h.rotate(t.rotation), h.scale(l, d));
            ...
            this._nodes.forEach((t => {
                ...
                const s = new a;
                s.multiply(r.copy().invert()).multiply(c).multiply(r).multiply(n);
                const o = s.decompose();
                t.setAttrs(o), this._fire("transform", {
                    evt: e,
                    target: t
                }), t._fire("transform", {
                    evt: e,
        ...
        destroy() {
            return this.getStage() && this._cursorChange && this.getStage().content && (this.getStage().content.style.cursor = ""), Xt.prototype.destroy.call(this), this.detach(), this._removeEvents(), this
        }
        toObject() {
    ...
    ai.prototype.className = "Transformer", r(ai), w.addGetterSetter(ai, "enabledAnchors", ei, (function(t) {
        return t instanceof Array || g.warn("enabledAnchors value should be an array"), t instanceof Array && t.forEach((function(t) {
            -1 === ei.indexOf(t) && g.warn("Unknown anchor name: " + t + ". Available names are: " + ei.join(", "))
        })), t || []
    })), w.addGetterSetter(ai, "flipEnabled", !0, x()), w.addGetterSetter(ai, "resizeEnabled", !0), w.addGetterSetter(ai, "anchorSize", 10, p()), w.addGetterSetter(ai, "rotateEnabled", !0), w.addGetterSetter(ai, "rotateLineVisible", !0), w.addGetterSetter(ai, "rotationSnaps", []), w.addGetterSetter(ai, "rotateAnchorOffset", 50, p()), w.addGetterSetter(ai, "rotateAnchorCursor", "crosshair"), w.addGetterSetter(ai, "rotationSnapTolerance", 5, p()), w.addGetterSetter(ai, "borderEnabled", !0), w.addGetterSetter(ai, "anchorStroke", "rgb(0, 161, 255)"), w.addGetterSetter(ai, "anchorStrokeWidth", 1, p()), w.addGetterSetter(ai, "anchorFill", "white"), w.addGetterSetter(ai, "anchorCornerRadius", 0, p()), w.addGetterSetter(ai, "borderStroke", "rgb(0, 161, 255)"), w.addGetterSetter(ai, "borderStrokeWidth", 1, p()), w.addGetterSetter(ai, "borderDash"), w.addGetterSetter(ai, "keepRatio", !0), w.addGetterSetter(ai, "shiftBehavior", "default"), w.addGetterSetter(ai, "centeredScaling", !1), w.addGetterSetter(ai, "ignoreStroke", !1), w.addGetterSetter(ai, "padding", 0, p()), w.addGetterSetter(ai, "node"), w.addGetterSetter(ai, "nodes"), w.addGetterSetter(ai, "boundBoxFunc"), w.addGetterSetter(ai, "anchorDragBoundFunc"), w.addGetterSetter(ai, "anchorStyleFunc"), w.addGetterSetter(ai, "shouldOverdrawWholeArea", !1), w.addGetterSetter(ai, "useSingleNodeRotation", !0), w.backCompat(ai, {
    ...
    ni.prototype.className = "Wedge", ni.prototype._centroid = !0, ni.prototype._attrsAffectingSize = ["radius"], r(ni), w.addGetterSetter(ni, "radius", 0, p()), w.addGetterSetter(ni, "angle", 0, p()), w.addGetterSetter(ni, "clockwise", !1), w.backCompat(ni, {
        angleDeg: "angle",
        getAngleDeg: "getAngle",
        setAngleDeg: "setAngle"
    });
    var oi = [512, 512, 456, 512, 328, 456, 335, 512, 405, 328, 271, 456, 388, 335, 292, 512, 454, 405, 364, 328, 298, 271, 496, 456, 420, 388, 360, 335, 312, 292, 273, 512, 482, 454, 428, 405, 383, 364, 345, 328, 312, 298, 284, 271, 259, 496, 475, 456, 437, 420, 404, 388, 374, 360, 347, 335, 323, 312, 302, 292, 282, 273, 265, 512, 497, 482, 468, 454, 441, 428, 417, 405, 394, 383, 373, 364, 354, 345, 337, 328, 320, 312, 305, 298, 291, 284, 278, 271, 265, 259, 507, 496, 485, 475, 465, 456, 446, 437, 428, 420, 412, 404, 396, 388, 381, 374, 367, 360, 354, 347, 341, 335, 329, 323, 318, 312, 307, 302, 297, 292, 287, 282, 278, 273, 269, 265, 261, 512, 505, 497, 489, 482, 475, 468, 461, 454, 447, 441, 435, 428, 422, 417, 411, 405, 399, 394, 389, 383, 378, 373, 368, 364, 359, 354, 350, 345, 341, 337, 332, 328, 324, 320, 316, 312, 309, 305, 301, 298, 294, 291, 287, 284, 281, 278, 274, 271, 268, 265, 262, 259, 257, 507, 501, 496, 491, 485, 480, 475, 470, 465, 460, 456, 451, 446, 442, 437, 433, 428, 424, 420, 416, 412, 408, 404, 400, 396, 392, 388, 385, 381, 377, 374, 370, 367, 363, 360, 357, 354, 350, 347, 344, 341, 338, 335, 332, 329, 326, 323, 320, 318, 315, 312, 310, 307, 304, 302, 299, 297, 294, 292, 289, 287, 285, 282, 280, 278, 275, 273, 271, 269, 267, 265, 263, 261, 259],
        hi = [9, 11, 12, 13, 13, 14, 14, 15, 15, 15, 15, 16, 16, 16, 16, 17, 17, 17, 17, 17, 17, 17, 18, 18, 18, 18, 18, 18, 18, 18, 18, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24];
    ...
    function li(t, e, i, r, a) {
        var n = i - e,
            s = a - r;
        return 0 === n ? r + s / 2 : 0 === s ? r : s * ((t - e) / n) + r
    }
    w.addGetterSetter(V, "embossStrength", .5, p(), w.afterSetFilter), w.addGetterSetter(V, "embossWhiteLevel", .5, p(), w.afterSetFilter), w.addGetterSetter(V, "embossDirection", "top-left", null, w.afterSetFilter), w.addGetterSetter(V, "embossBlend", !1, null, w.afterSetFilter);
    w.addGetterSetter(V, "enhance", 0, p(), w.afterSetFilter);
    w.addGetterSetter(V, "hue", 0, p(), w.afterSetFilter), w.addGetterSetter(V, "saturation", 0, p(), w.afterSetFilter), w.addGetterSetter(V, "luminance", 0, p(), w.afterSetFilter);
    w.addGetterSetter(V, "hue", 0, p(), w.afterSetFilter), w.addGetterSetter(V, "saturation", 0, p(), w.afterSetFilter), w.addGetterSetter(V, "value", 0, p(), w.afterSetFilter);
    ...
    w.addGetterSetter(V, "kaleidoscopePower", 2, p(), w.afterSetFilter), w.addGetterSetter(V, "kaleidoscopeAngle", 0, p(), w.afterSetFilter);
    w.addGetterSetter(V, "threshold", 0, p(), w.afterSetFilter);
    w.addGetterSetter(V, "noise", .2, p(), w.afterSetFilter);
    w.addGetterSetter(V, "pixelSize", 8, p(), w.afterSetFilter);
    w.addGetterSetter(V, "levels", .5, p(), w.afterSetFilter);
    ...
    w.addGetterSetter(V, "red", 0, (function(t) {
        ...
        return this._filterUpToDate = !1, t > 255 ? 255 : t < 0 ? 0 : Math.round(t)
    })), w.addGetterSetter(V, "blue", 0, f, w.afterSetFilter), w.addGetterSetter(V, "alpha", 1, (function(t) {
        return this._filterUpToDate = !1, t > 1 ? 1 : t < 0 ? 0 : t
    }));
    w.addGetterSetter(V, "threshold", .5, p(), w.afterSetFilter);
    return Zt.Util._assign(Zt, {
        ...
        Filters: {
            Blur: function(t) {
                ...
                e > 0 && function(t, e) {
                    var i, r, a, n, s, o, h, l, d, c, g, u, f, p, v, m, _, y, x, b, S, w, C, P, k = t.data,
                        A = t.width,
                        T = t.height,
                        M = e + e + 1,
                        G = A - 1,
                        ...
                        B = oi[e],
                        H = hi[e];
                    for (a = 1; a < M; a++) I = I.next = new si, a === E && (O = I);
                    for (I.next = L, h = o = 0, r = 0; r < T; r++) {
                        for (m = _ = y = x = l = d = c = g = 0, u = E * (b = k[o]), f = E * (S = k[o + 1]), p = E * (w = k[o + 2]), v = E * (C = k[o + 3]), l += D * b, d += D * S, c += D * w, g += D * C, I = L, a = 0; a < E; a++) I.r = b, I.g = S, I.b = w, I.a = C, I = I.next;
                        for (a = 1; a < E; a++) n = o + ((G < a ? G : a) << 2), l += (I.r = b = k[n]) * (P = E - a), d += (I.g = S = k[n + 1]) * P, c += (I.b = w = k[n + 2]) * P, g += (I.a = C = k[n + 3]) * P, m += b, _ += S, y += w, x += C, I = I.next;
                        for (F = L, N = O, i = 0; i < A; i++) k[o + 3] = C = g * B >> H, 0 !== C ? (C = 255 / C, k[o] = (l * B >> H) * C, k[o + 1] = (d * B >> H) * C, k[o + 2] = (c * B >> H) * C) : k[o] = k[o + 1] = k[o + 2] = 0, l -= u, d -= f, c -= p, g -= v, u -= F.r, f -= F.g, p -= F.b, v -= F.a, n = h + ((n = i + e + 1) < G ? n : G) << 2, l += m += F.r = k[n], d += _ += F.g = k[n + 1], c += y += F.b = k[n + 2], g += x += F.a = k[n + 3], F = F.next, u += b = N.r, f += S = N.g, p += w = N.b, v += C = N.a, m -= b, _ -= S, y -= w, x -= C, N = N.next, o += 4;
                        h += A
                    }
                    for (i = 0; i < A; i++) {
                        for (_ = y = x = m = d = c = g = l = 0, u = E * (b = k[o = i << 2]), f = E * (S = k[o + 1]), p = E * (w = k[o + 2]), v = E * (C = k[o + 3]), l += D * b, d += D * S, c += D * w, g += D * C, I = L, a = 0; a < E; a++) I.r = b, I.g = S, I.b = w, I.a = C, I = I.next;
                        for (s = A, a = 1; a <= e; a++) o = s + i << 2, l += (I.r = b = k[o]) * (P = E - a), d += (I.g = S = k[o + 1]) * P, c += (I.b = w = k[o + 2]) * P, g += (I.a = C = k[o + 3]) * P, m += b, _ += S, y += w, x += C, I = I.next, a < R && (s += A);
                        for (o = i, F = L, N = O, r = 0; r < T; r++) k[3 + (n = o << 2)] = C = g * B >> H, C > 0 ? (C = 255 / C, k[n] = (l * B >> H) * C, k[n + 1] = (d * B >> H) * C, k[n + 2] = (c * B >> H) * C) : k[n] = k[n + 1] = k[n + 2] = 0, l -= u, d -= f, c -= p, g -= v, u -= F.r, f -= F.g, p -= F.b, v -= F.a, n = i + ((n = r + E) < R ? n : R) * A << 2, l += m += F.r = k[n], d += _ += F.g = k[n + 1], c += y += F.b = k[n + 2], g += x += F.a = k[n + 3], F = F.next, u += b = N.r, f += S = N.g, p += w = N.b, v += C = N.a, m -= b, _ -= S, y -= w, x -= C, N = N.next, o += A
                    }
                }(t, e)
            },
            Brighten: function(t) {
                    ...
                    do {
                        ...
                        if ((b > 0 ? b : -b) > C && (w = b), (S > 0 ? S : -S) > C && (w = S), w *= e, a) {
                            var P = o[m] + w,
                                k = o[m + 1] + w,
                                A = o[m + 2] + w;
                            o[m] = P > 255 ? 255 : P < 0 ? 0 : P, o[m + 1] = k > 255 ? 255 : k < 0 ? 0 : k, o[m + 2] = A > 255 ? 255 : A < 0 ? 0 : A
                        } else {
                            var T = i - w;
                            T < 0 ? T = 0 : T > 255 && (T = 255), o[m] = o[m + 1] = o[m + 2] = T
                        }
                    } while (--v)
                } while (--c)
            },
            Enhance: function(t) {
                var e, i, r, a, n = t.data,
                    s = n.length,
                    o = n[0],
                    h = o,
                    l = n[1],
                ...
                if (0 !== u) {
                    ...
                    for (h === o && (h = 255, o = 0), d === l && (d = 255, l = 0), g === c && (g = 255, c = 0), u > 0 ? (p = h + u * (255 - h), v = o - u * (o - 0), _ = d + u * (255 - d), y = l - u * (l - 0), b = g + u * (255 - g), S = c - u * (c - 0)) : (p = h + u * (h - (f = .5 * (h + o))), v = o + u * (o - f), _ = d + u * (d - (m = .5 * (d + l))), y = l + u * (l - m), b = g + u * (g - (x = .5 * (g + c))), S = c + u * (c - x)), a = 0; a < s; a += 4) n[a + 0] = li(n[a + 0], o, h, v, p), n[a + 1] = li(n[a + 1], l, d, y, _), n[a + 2] = li(n[a + 2], c, g, S, b)
                }
            },
            ...
            HSL: function(t) {
                var e, i, r, a, n, s = t.data,
                    ...
                    x = .587 - .586 * c - 1.05 * g,
                    b = .114 + .886 * c - .2 * g;
                for (e = 0; e < o; e += 4) i = s[e + 0], r = s[e + 1], a = s[e + 2], n = s[e + 3], s[e + 0] = u * i + f * r + p * a + d, s[e + 1] = v * i + m * r + _ * a + d, s[e + 2] = y * i + x * r + b * a + d, s[e + 3] = n
            },
            HSV: function(t) {
                var e, i, r, a, n, s = t.data,
                    o = s.length,
                    ...
                    _ = .114 * h - .114 * c + .293 * g,
                    y = .299 * h - .3 * c + 1.25 * g,
                    x = .587 * h - .586 * c - 1.05 * g,
                    b = .114 * h + .886 * c - .2 * g;
                for (e = 0; e < o; e += 4) i = s[e + 0], r = s[e + 1], a = s[e + 2], n = s[e + 3], s[e + 0] = u * i + f * r + p * a, s[e + 1] = v * i + m * r + _ * a, s[e + 2] = y * i + x * r + b * a, s[e + 3] = n
            },
            Invert: function(t) {
                var e, i = t.data,
                    r = i.length;
            ...
            Kaleidoscope: function(t) {
                var e, i, r, a, n, s, o, h, l, d = t.width,
                    c = t.height,
                ...
                if (!(u < 1)) {
                    ...
                    g.releaseCanvas(v),
                        function(t, e, i) {
                            ...
                            var _, y, x, b, S = d,
                                ...
                                C = 360 / w * Math.PI / 180;
                            for (y = 0; y < w; y += 1)
                                for (x = Math.sin(y * C), b = Math.cos(y * C), _ = 0; _ < S; _ += 1) a = Math.floor(c + m * _ / S * b), u = o[0 + (r = 4 * ((n = Math.floor(g + m * _ / S * x)) * l + a))], f = o[r + 1], p = o[r + 2], v = o[r + 3], h[0 + (r = 4 * (y + _ * l))] = u, h[r + 1] = f, h[r + 2] = p, h[r + 3] = v
                        }(t, m, {
                            polarCenterX: d / 2,
                            polarCenterY: c / 2
                        });
                    ...
                    for (p + _ > d && (x = y, b = 0, S = -1), i = 0; i < c; i += 1)
                        for (e = x; e !== b; e += S) h = 4 * (d * i + Math.round(e + p) % d), a = m.data[h + 0], n = m.data[h + 1], s = m.data[h + 2], o = m.data[h + 3], l = 4 * (d * i + e), m.data[l + 0] = a, m.data[l + 1] = n, m.data[l + 2] = s, m.data[l + 3] = o;
                    for (i = 0; i < c; i += 1)
                        for (y = Math.floor(_), r = 0; r < u; r += 1) {
                            for (e = 0; e < y + 1; e += 1) h = 4 * (d * i + e), a = m.data[h + 0], n = m.data[h + 1], s = m.data[h + 2], o = m.data[h + 3], l = 4 * (d * i + 2 * y - e - 1), m.data[l + 0] = a, m.data[l + 1] = n, m.data[l + 2] = s, m.data[l + 3] = o;
                            y *= 2
                        }! function(t, e, i) {
                            var r, a, n, s, o, h, l = t.data,
                                d = e.data,
                                c = t.width,
                                g = t.height,
                            ...
                            var x, b, S, w = g,
                                ...
                                P = i.polarRotation || 0;
                            for (a = 0; a < c; a += 1)
                                for (n = 0; n < g; n += 1) s = a - u, o = n - f, x = Math.sqrt(s * s + o * o) * w / y, b = (b = (180 * Math.atan2(o, s) / Math.PI + 360 + P) % 360) * C / 360, S = Math.floor(b), p = l[0 + (r = 4 * (Math.floor(x) * c + S))], v = l[r + 1], m = l[r + 2], _ = l[r + 3], d[0 + (r = 4 * (n * c + a))] = p, d[r + 1] = v, d[r + 2] = m, d[r + 3] = _
                        }(m, t, {
                            polarRotation: 0
                        })
                }
            ...
            Mask: function(t) {
                var e = function(t, e) {
                    var i = di(t, 0, 0),
                        r = di(t, t.width - 1, 0),
                        a = di(t, 0, t.height - 1),
                        n = di(t, t.width - 1, t.height - 1),
                        s = e || 10;
                    if (ci(i, r) < s && ci(r, n) < s && ci(n, a) < s && ci(a, i) < s) {
                        for (var o = function(t) {
                                for (var e = [0, 0, 0], i = 0; i < t.length; i++) e[0] += t[i][0], e[1] += t[i][1], e[2] += t[i][2];
                                return e[0] /= t.length, e[1] /= t.length, e[2] /= t.length, e
                            }([r, i, n, a]), h = [], l = 0; l < t.width * t.height; l++) {
                            var d = ci(o, [t.data[4 * l], t.data[4 * l + 1], t.data[4 * l + 2]]);
                            h[l] = d < s ? 0 : 255
                        }
                        return h
                    }
                ...
                return e && function(t, e) {
                    ...
                    for (var r = [1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9, 1 / 9], a = Math.round(Math.sqrt(r.length)), n = Math.floor(a / 2), s = [], o = 0; o < i; o++)
                        for (var h = 0; h < e; h++) {
                    ...
                    for (var r = [1, 1, 1, 1, 1, 1, 1, 1, 1], a = Math.round(Math.sqrt(r.length)), n = Math.floor(a / 2), s = [], o = 0; o < i; o++)
                        for (var h = 0; h < e; h++) {
                            for (var l = o * e + h, d = 0, c = 0; c < a; c++)
                                for (var g = 0; g < a; g++) {
                                    var u = o + c - n,
                    ...
                    for (var r = [1, 1, 1, 1, 0, 1, 1, 1, 1], a = Math.round(Math.sqrt(r.length)), n = Math.floor(a / 2), s = [], o = 0; o < i; o++)
                        for (var h = 0; h < e; h++) {
                            for (var l = o * e + h, d = 0, c = 0; c < a; c++)
                                for (var g = 0; g < a; g++) {
                                    var u = o + c - n,
            ...
            Pixelate: function(t) {
                var e, i, r, a, n, s, o, h, l, d, c, u, f, p, v = Math.ceil(this.pixelSize()),
                    m = t.width,
                    _ = t.height,
                    y = Math.ceil(m / v),
                    x = Math.ceil(_ / v),
                    ...
                    for (u = 0; u < y; u += 1)
                        for (f = 0; f < x; f += 1) {
                            for (a = 0, n = 0, s = 0, o = 0, l = (h = u * v) + v, c = (d = f * v) + v, p = 0, e = h; e < l; e += 1)
                                if (!(e >= m))
                                    for (i = d; i < c; i += 1) i >= _ || (a += b[(r = 4 * (m * i + e)) + 0], n += b[r + 1], s += b[r + 2], o += b[r + 3], p += 1);
                            for (a /= p, n /= p, s /= p, o /= p, e = h; e < l; e += 1)
                                if (!(e >= m))
                                    for (i = d; i < c; i += 1) i >= _ || (b[(r = 4 * (m * i + e)) + 0] = a, b[r + 1] = n, b[r + 2] = s, b[r + 3] = o)
                        }
            },
